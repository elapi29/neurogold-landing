...
export default function NeuroscienceHero() {
  // Tipamos el estado para evitar "implicit any"
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 py-20">
        <div className="text-center space-y-8 max-w-5xl">
          ...
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight">
            ...
            <br />
            <span className="text-slate-100">Component Analysis</span>
          </h1>

          {/* Subheading */}
          <p className="text-xl md:text-2xl text-purple-200/80 font-light max-w-3xl mx-auto leading-relaxed">
            Exploring the frontiers of computational neuroscience through advanced signal
            processing and multivariate analysis
          </p>

          {/* CTA buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            <button className="group relative px-8 py-4 bg-gradient-to-r from-violet-600 to-purple-600 rounded-full font-semibold text-white shadow-lg shadow-purple-500/50 hover:shadow-purple-500/70 transition-all duration-300 hover:scale-105">
