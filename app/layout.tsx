...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Neurogold Training", description: "Alto rendimiento con neurociencia aplicada.", url: "/", siteName: "Neurogold Training", images: [{ url: "/og.png", width: 1200, height: 630 }], locale: "es_AR", type: "website" },
